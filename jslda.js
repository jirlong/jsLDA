...
//var wordPattern = XRegExp("\\S+", "g");
//var wordPattern = XRegExp("[\u4E00-\u9FCC\u3400-\u4DB5\uFA0E\uFA0F\uFA11\uFA13\uFA14\uFA1F\uFA21\uFA23\uFA24\uFA27-\uFA29]|[\ud840-\ud868][\udc00-\udfff]|\ud869[\udc00-\uded6\udf00-\udfff]|[\ud86a-\ud86c][\udc00-\udfff]|\ud86d[\udc00-\udf34\udf40-\udfff]|\ud86e[\udc00-\udc1d]+", "g");
var wordPattern = XRegExp("[^0-9\\s_]+", "g");
...
//    var tokened = jieba.cut(text);
//    console.log(tokened);
//    
//    jieba.cut(text, function(_result){
    var _custom_dict = [
	["漫畫", 9999999999, "n"],
    ["台灣", 9999999999, "n"],
    ["移工", 9999999999, "n"],
    ...
    call_jieba_cut(text, _custom_dict, function (_result) {
        var rawTokens = _result;
        console.log(rawTokens);
        var tokens = [];
//        var rawTokens = text.match(wordPattern);
        if (rawTokens == null) {
            return;
        }
